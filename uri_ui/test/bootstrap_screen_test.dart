...
void main() {
  ...
  testWidgets(
    'a fresh launch with no configured address shows the bootstrap screen, not login',
    (tester) async {
  ...
  testWidgets(
    'a non-localhost address can be typed and tested before authentication',
    (tester) async {
  ...
  testWidgets(
    'a successful connection applies the address and transitions straight to login',
    (tester) async {
      final client = await pumpFreshLaunch(tester);
  ...
  testWidgets(
    'a failed connection stays on the bootstrap screen and shows the diagnostic detail',
    (tester) async {
      final client = await pumpFreshLaunch(tester);
  ...
  testWidgets(
    'once authenticated, Settings > URI server still works exactly as before',
    (tester) async {
      final client = await pumpFreshLaunch(tester);
