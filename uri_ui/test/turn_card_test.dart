...
void main() {
  ...
  testWidgets('a failed turn with no understanding text still shows the failure reason', (
    tester,
  ) async {
    final turn = UriTurn(
      id: 't1',
  ...
  testWidgets('a failed turn with both understanding and failureReason shows both', (
    tester,
  ) async {
    final turn = UriTurn(
      id: 't1',
    ...
    expect(find.text('No drafted output was available for review.'), findsOneWidget);
  });

  testWidgets('a non-failed turn never shows failure styling even if failureReason were set', (
    tester,
  ) async {
    final turn = UriTurn(
      id: 't1',
