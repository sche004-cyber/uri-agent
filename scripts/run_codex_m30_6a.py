"""Execute Codex CLI for M30.6A implementation via stdin piping."""
import subprocess
import sys
import os
...
task_file = os.path.join(workspace_dir, "uri_workspace", "dev_workflow", "tasks", "m30_6a_codex_implementation_task.txt")

with open(task_file, "r", encoding="utf-8") as f:
    task_prompt = f.read()

print(f"Launching Codex CLI on {workspace_dir} for M30.6A...", flush=True)
