"""Execute Codex for Batch 2 via stdin piping."""
import subprocess
import sys
import os
...
task_file = os.path.join(workspace_dir, "uri_workspace", "dev_workflow", "tasks", "batch2_task.txt")

with open(task_file, "r", encoding="utf-8") as f:
    task_prompt = f.read()

print(f"Launching Codex CLI on {workspace_dir} with Batch 2 task...", flush=True)
